...
for prefecture_idx, prefecture in prefecture_codes.iterrows():
    ...
    data.drop(columns=['Price information classification', 'City,Town,Ward,Village code', 'District', 'Nearest station : Name', 
    ...
    # Save the datasets
    land_only_df.to_csv(f'./Cleaned_Data_Sets/2005_2024/{prefecture_name}_cleaned_test_landOnly.csv', index=False)
    building_df.to_csv(f'./Cleaned_Data_Sets/2005_2024/{prefecture_name}_cleaned_test_buildings.csv', index=False)
