...
class PlotPredictionsCallback_log(tf.keras.callbacks.Callback):
    def __init__(self, dev_features, dev_target_log, out_dir="epoch_plots_true_v_pred"):
       ...
       'Region_Kyushu', 'Region_Shikoku', 'Region_Tohoku', 'Close_to_Tokyo',
       'Close_to_greater_Tokyo_area', 'Close_to_designated_city_flag',
       'Migration_scaled', 'Distance_to_designated_city_scaled',
